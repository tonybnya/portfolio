  ...
  return (
    <div className="w-full">
      {[1, 2, 3].map((item) => (
        <div
          key={item}
          className="flex flex-col relative border-l border-[#1d1d1d] h-32"
        >
          <div className="mb-10 ml-4 w-full text-left">
            <div className="absolute w-3 h-3 bg-[#050403] rounded-full mt-1.5 -left-1.5 border border-[#1d1d1d]" />
