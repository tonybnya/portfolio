  ...
  return (
      <div className="border-2 border-stone-900 rounded-md overflow-hidden">
         ...
         <div className="w-full p-4">
            <h3 className="text-lg md:text-xl mb-2 md:mb-3 font-righteous">{title}</h3>
            ...
            <p className="flex flex-wrap gap-2 flex-row items-center justify-start mb-4 text-xs md:text-sm">
              ...
              <div className='flex gap-3'>
                  <a href={link} target='_blank'><i class="fa-solid fa-globe"></i> Live</a>
                  <a href={source} target='_blank'><i class="fa-brands fa-github"></i> Source</a>
            </div>
         </div>
    </div>
  )
