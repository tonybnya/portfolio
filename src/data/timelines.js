const timelines = [
  ...
  {
    year: "2021",
    title: "Consultant - Team Solutions",
    duration: "ongoing",
    details:
  ...
  {
    year: "2022",
    title: "Front-End Web Development Gratuated - Sayna Academy",
    duration: "6 months",
    details:
  ...
  {
    year: "2023",
    title: "Software Engineering Graduated - ALX",
    duration: "12 months",
    details:
      "Over a transformative 12-month journey, I immersed myself in a comprehensive software engineering course designed the amazing ALX, to equip aspiring developers with the skills and knowledge needed to thrive in the industry. Throughout the program, I delved deeply into various facets of software engineering, covering topics such as programming languages, data structures and algorithms, software architecture, system design, project management.... Through a blend of theoretical learning and practical application, I gained proficiency in a wide array of technologies and methodologies, including but not limited to C, Python, JavaScript, version control systems, agile development practices, and software design patterns, databases. Hands-on projects, collaborative assignments, and real-world simulations provided invaluable opportunities to apply theoretical concepts in practical scenarios, fostering a deep understanding of software engineering principles. This intensive course not only expanded my technical capabilities but also instilled in me a strong problem-solving mindset, effective communication skills, and a passion for continuous learning and innovation in the ever-evolving field of software engineering.",
  },
  {
    year: "2024",
    title: "Open Source Contributor - All In Open Source by GitHub",
    duration: "3 months",
    details:
  ...
  {
    year: "2024",
    title: "AI Career Essentials Certified - ALX",
    duration: "6 weeks",
    details:
      "Embarking on the AI Career Essentials (AiCE), another wonderful program designed one more time by ALX, was a pivotal step in my journey towards mastering essential AI literacy skills and igniting my career in the tech industry. What sets AiCE apart is its unique blend of technical expertise, professional development, and hands-on Al tools training, all integrated seamlessly into one comprehensive program. Engaging in immersive simulations that closely mirror real-world scenarios, I gained practical insights and honed the skills necessary to thrive in today's fast-paced digital workforce. This experiential learning approach not only equipped me with valuable knowledge but also instilled in me the confidence to tackle complex challenges head-on and excel in the ever-evolving field of artificial intelligence.",
  },
];
